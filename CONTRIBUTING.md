...
Thanks for taking the time to contribute! This is a small, dependency-free
...
3. There are no dependencies to install. Run the CLI locally against any
...
- Keep the project **zero-dependency**. New runtime dependencies will not be
  merged.
...
3. Manually verify the CLI still works for the common cases:
...
4. Update `README.md` if you changed behavior, options, or output.
